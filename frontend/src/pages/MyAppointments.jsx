    ...
    <div>
      ...
      <div>
        {appointments.map((item,index)=>(
          <div className='grid grid-cols-[1fr_2fr] gap-4  sm:flex sm:gap-6 py-2 bprder-b' key={index}>
            <div>
            ...
            <p className='text-xs mt-1'><span className='text-sm text-neutral-700 font-medium'>Date & Time : <span>{slotDataFormat(item.slotDate)}| {item.slotTime}</span></span></p>
            </div>
            <div></div>
