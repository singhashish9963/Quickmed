    ...
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <div className='flex items-center gap-4'>
        ...
        <div className='flex items-center gap-2 cursor-pointer group relative'>
         ...
         <div className='absolute top-8 right-0 bg-white p-4 rounded-lg  hidden group-hover:block'>
            <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4'>
            <p onClick={()=>navigate('/my-profile')} className='text-stone-700 hover:text-black  cursor-pointer'>My profile</p>
            <p onClick={()=>navigate('/my-appointments')} className='text-stone-700 hover:text-black cursor-pointer'>My appointment</p>
            <p onClick={logout} className='text-stone-700 hover:text-black cursor-pointer'>Logout</p>
            </div>
         </div>
        </div>
